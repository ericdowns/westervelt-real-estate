...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      "size-h2": ["45px", { lineHeight: "1.25" }],
      "size-h3": ["38px", { lineHeight: "1.17" }],
      "size-h4": ["32px", { lineHeight: "1.15" }],
      "size-h5": ["26px", { lineHeight: "1.25" }],
      "size-h6": ["12px", { lineHeight: "1.35" }],
      ...
      "size-m-h6": ["12px", { lineHeight: "1.2" }],
        ...
        // Paragraph sizes
      "p-base": ["18px", { lineHeight: "1.4" }],
      "p-sm": ["14px", { lineHeight: "1.4" }],
      "p-xs": ["12px", { lineHeight: "1.4" }],
      "p-m-base": ["16px", { lineHeight: "1.4" }],
      "p-m-sm": ["14px", { lineHeight: "1.4" }],
    },
