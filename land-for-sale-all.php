...
<head>
	...
	<title>Westervelt Real Estate - Land for Sale</title>
...
<body class="min-h-screen flex flex-col">
	...
	<main class="mx-auto flex-grow w-full pt-[140px]">
		<div class="bg-tan">
			...
			<div class="content grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-y-10 gap-x-5 pb-10 pt-5">
				<?php for ($i = 0; $i < 12; $i++) {include './components/cards/card_land.php'; } ?>
			</div>
			<div class="pagination content pb-16 flex justify-center">
