...
<div id="toggleBox" class="bg-white shadow-xl fixed rounded-lg left-10 bottom-10 flex flex-col w-[300px] hover:[&>a]:bg-gray-200 text-sm z-[999] p-4 pt-2 space-y-1 border-2 transition-all duration-300">
	...
	<a href="#">Residential Sales - All 🛑</a>
	<a href="#">Residential Community 🛑</a>
	<a href="#">Residential Single 🛑</a>
...
<div class="message_bar flex justify-between items-center px-5 bg-white h-[44px] ">
...
<nav class="bg-white/90 h-[95px] flex items-center">
